                    ...
                    <div class="row">
                        <div class="col-lg-5 col-md-12">
                            ...
                            <ul class="contact-social list-unstyled d-flex mt-30 mb-0">
                                ...
                                <li><a href="javascript:void(0)" class="text-white d-inline-block text-center" style="background-color: #e62d31;"><i class="fab fa-google-plus-g"></i></a></li>
                                ...
                                <li><a href="javascript:void(0)" class="text-white d-inline-block text-center" style="background-color: #0f9cd6;"><i class="fab fa-linkedin-in"></i></a></li>
                            </ul>
                        </div>
